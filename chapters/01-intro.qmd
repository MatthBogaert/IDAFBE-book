...
![The 5 Vs of big data: volume, velocity, variety, veracity, and value — the impact on your firm.](../images/ch01-fig-bigdata-4vs.png){#fig-bigdata fig-alt="Five core elements arranged around the concepts of 'Big Data': Volume (amount), Velocity (speed), Variety (forms), Veracity (uncertainty), and Value (impact), with Value added as a distinct element."}
